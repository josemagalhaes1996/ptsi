                        ...
                        <div id="listagem" style="margin-left: 8%;">
                            <div class="wrapper">
                                ...
                                <div class="infoproduto" id="infoprod">
                                    ...
                                    ?>
                                    <a title="Editar" href="produtoEdit.php?id=<?= $dados['numero_produto'] ?>"><img src="editpro.png" width="60" height="20"></a>
                                    <a title="Eliminar" href="produtoDel.php?id=<?= $dados['numero_produto'] ?>" onclick="return eliminar()"><img src="lixo.png" width="30" height="20"></a>
