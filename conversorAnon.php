	...
	<body>
            ...
            <div id="mainbodymp">
                <div id="novosprodutosbar">
                    <h3 style="padding-left: 0.5%" class="bar-title">Conversor</h3>
               </div>
                
                <div id="conversor">
                <form action="conversorAnon.php" method="post">
                    <p> Montante: <br/>
                        <input required="" type="number" min="0" name="montante"/> 
                    </p>
                    <p> De: <br/>
...
?>
                ...
                <div id="conversor2">
                <?php
                    echo $montante." ".$de." = ".currency($de,$para , $montante)." ".$para; 
                    ?>
                </div>
